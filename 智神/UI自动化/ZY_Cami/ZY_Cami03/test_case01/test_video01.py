...
from test_case01.test_countdown01 import Countdown
class Video_Setting(Countdown):
    """视频"""
    def __init__(self):
        """self.pics = Beautify_Fair()
        self.driver = self.pics.devices()
        self.pics.connecting01()"""
        # Countdown.__init__(self)#直接继承Countdown构造方法，如果用了 devices会重启
        self.devices()
        self.connecting01()
        pass
    ...
    def back(self):
        ...
        driver.find_element_by_id("com.zhiyun.cama:id/iv_back").click()
        print(vide.picture_01())
        return '返回按钮'
