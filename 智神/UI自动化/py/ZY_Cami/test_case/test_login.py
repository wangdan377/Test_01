...
class LoginTest(unittest.TestCase):
    ...
    def test_login(self):
        ...
        # 进入首页后点击我的按钮
        time.sleep(5)
        # driver.find_element_by_id('main_bottom_me').click()    #我的按钮
        driver.find_element_by_xpath("//android.widget.FrameLayout[@content-desc=\"Me\"]/android.widget.ImageView").click()
        time.sleep(5)
        ...
        driver.find_element_by_id('et_name').set_value('16221031711')
        # 清空密码输入框并输入密码
        ...
        # driver.save_screenshot('../screen/test_login.png')   #第二种方式--->正确的,可以用来保存截图
        ...
        time.sleep(2)
        # 弹出退出提示弹框，点击确定
        # driver.find_element_by_id('android:id/button1').click()   #哪里跳出来的  不能用了  报错
