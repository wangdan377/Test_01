...
class MyTest(unittest.TestCase):
    ...
    def test_01(self):
        ...
        '''获取开发者全部应用'''
        list_url = js_url +"settle/appInfo/list"
        ...
        '''查询应用参数'''
        getAppInfo_url = js_url +"/settle/appInfo/getAppInfo"
        ...
        '''获取支付宝渠道参数'''
        getPayChannels_url = js_url + "/appInfo/getPayChannels"
        ...
        if 'utMsg' in response_Template_create.text:
            ...
            print('分润模板添加成功')
        '''删除分润模板'''
        Template_delete_url=js_url + '/royaltyTemplate/delete'
        ...
        if 'utMsg' in response_Template_delete.text:
            ...
            print('删除分润')
        '''查询分润模板详情'''
        royaltyTemplate_url= js_url +'/royaltyTemplate/get'
        ...
        if 'utMsg' in response_royaltyTemplate.text:
            ...
            print('查询分润模板详情')
        '''查询分润模板列表'''
        Template_list_url= js_url +'/royaltyTemplate/list'
