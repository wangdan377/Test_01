...
def run_test_by_pytest(test_path, rerun=3, xdist='auto', **allure):
    # 检查路径
    ...
    # 运行 pytest 命令
    pytest_cmd = f'pytest --rootdir={test_path} --alluredir {raw_path} --reruns={rerun} -n={xdist} --dist=loadscope'
